...
/**
 * Rele_permissions class
 */
class Rele_permissions extends Migration
{
	...
	public function up() {
		...
		$this->createTable('rele_permissions');
		 ...
		 * 	'gender'=>'male'
		 * ]);
		 * $this->insert('rele_permissions')
		 */

	}

	public function down() {
		$this->dropTable('rele_permissions');
	}
}