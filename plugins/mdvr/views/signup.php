...
<main class="p-4" style="background-color: #dde5f4;">
    <form method="post" class="col-xl-3 col-lg-4 col-md-6 col-sm-8 mx-auto p-4 shadow" style="border-radius: 40px; background-color: #f1f7fe">
        ...
        <div class="form-floating my-2">
            <input value="<?=old_value('password')?>" name="password" type="password" class="form-control" id="floatingInput" placeholder="name@example.com" style="border-radius: 40px;">
        ...
        <button class="btn text-white px-4 py-3 w-100 my-4" style="background-color: #3d4785; border-radius: 40px">Signup</button>
    </form>
</main>
