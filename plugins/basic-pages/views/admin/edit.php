<?php if(user_can('edit_page')):?>
	...
	<?php if(!empty($row)):?>
		...
		<form onsubmit="page.submit(event)" method="post" enctype="multipart/form-data">
			...
			<h4 class="text-center">Edit Website Page</h4>
			...
			<div class="row">
				...
				<div class="col-md-9">
					<div class="mb-3 col-md-12">
					  ...
					  <input name="title" value="<?=old_value('title',$row->title)?>" type="text" class="form-control" id="title" placeholder="Title">
					...
					<div class="mb-3 col-md-12">
					  ...
					  <input name="slug" value="<?=old_value('slug',$row->slug)?>" type="text" class="form-control" id="slug" placeholder="Slug">
					...
					<div class="mb-3 col-md-12">
					  ...
					  <input name="description" value="<?=old_value('description',$row->description)?>" type="text" class="form-control" id="description" placeholder="Description">
					...
					<div class="mb-3 col-md-12">
					  ...
					  <input name="keywords" value="<?=old_value('keywords',$row->keywords)?>" type="text" class="form-control" id="keywords" placeholder="Keywords">
	 		...
	 		<div class="mb-3 col-md-12">
			  <label for="content" class="form-label">Page content</label>
				<textarea rows="10" id="content" name="content" class="summernote form-control" placeholder="Your page content in HTML"><?=old_value('content',$row->content)?></textarea>
